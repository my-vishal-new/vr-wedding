function InfoBox(t) {
  (t = t || {}),
    ...
    "undefined" == typeof t.visible &&
      (t.visible = "undefined" == typeof t.isHidden ? !0 : !t.isHidden),
      ...
      if (
        ...
        this.div_.style.width
          ...
          ? ((this.div_.style.width = this.maxWidth_),
            ...
            (this.fixedWidthSet_ = !0))
          : ((i = this.getBoxWidths_()),
            (this.div_.style.width =
              this.div_.offsetWidth - i.left - i.right + "px"),
        ...
        for (
          ...
          this.eventListeners_.push(
            google.maps.event.addDomListener(this.div_, e[t], s)
          );
        this.eventListeners_.push(
  ...
  (InfoBox.prototype.panBox_ = function (t) {
    ...
    if (!t && ((e = this.getMap()), e instanceof google.maps.Map)) {
      ...
      if (
        (v.x < -l + _
          ? (o = v.x + l - _)
          : v.x + a + l + _ > h && (o = v.x + a + l + _ - h),
        this.alignBottom_
          ? v.y < -r + f + p
            ? (s = v.y + r - f - p)
            : v.y + r + f > d && (s = v.y + r + f - d)
          : v.y < -r + f
          ? (s = v.y + r - f)
          : v.y + p + r + f > d && (s = v.y + p + r + f - d),
        0 !== o || 0 !== s)
      ) {
        {
          e.getCenter();
